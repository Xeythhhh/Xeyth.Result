...
{
    /// <summary>Creates a failure <see cref="Result"/> if <paramref name="isFailure"/> is <see langword="true"/>, otherwise a success result.</summary>
    ...
    /// <summary>Creates a failure <see cref="Result"/> if <paramref name="isFailure"/> is <see langword="true"/>, otherwise a success result, with a lazily evaluated <see cref="IError"/>.</summary>
    /// <param name="isFailure">Indicates whether to create a failure result.</param>
