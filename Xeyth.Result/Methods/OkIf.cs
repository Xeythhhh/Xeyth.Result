...
{
    /// <summary>Represents the default error generated when the predicate fails, and no custom error factory is provided.</summary>
    ...
    /// <summary>The default factory function used to generate an error when the <see cref="OkIf{TError}(Func{bool}, Func{TError})" /> predicate fails. Defaults to creating an instance of <see cref="OkIf_PredicateError"/>.</summary>
    ...
    /// <summary>Creates a success or failure result based on the given predicate.</summary>
    ...
    /// <returns>A success result if the predicate returns <see langword="true"/>; otherwise, a failure result.</returns>
    ...
    /// <summary>Creates a success or failure result based on the given condition.</summary>
