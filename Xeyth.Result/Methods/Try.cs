...
public partial class Result
{
    ...
    /// <summary>Executes the specified <paramref name="func"/> and returns a <see cref="Result"/> indicating success or failure. If an exception is thrown, the <paramref name="exceptionHandler"/> transforms the exception into an <see cref="IError"/>.</summary>
    /// <param name="func">The action to execute.</param>
    /// <param name="exceptionHandler">A function to handle exceptions and transform them into an <see cref="IError"/>. Defaults to <see cref="Error.DefaultExceptionalErrorFactory"/>.</param>
    /// <returns>A successful <see cref="Result"/> if the <paramref name="func"/> executes without exceptions; otherwise, a failed <see cref="Result"/> with an error generated by <paramref name="exceptionHandler"/>.</returns>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="func"/> is <see langword="null"/>.</exception>
    public static Result Try(Func<Result> func, Func<Exception, IError>? exceptionHandler = null)
    {
